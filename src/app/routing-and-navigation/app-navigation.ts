...
export interface IAppNavigation {
    ...
    getGlobalNavigator(): any;
}

/**
 * Application Navigation Manager
 *
 * Handles routing using react-router-dom's history API
 * for programmatic navigation within the application.
 *
 * Implemented as a singleton to ensure only one instance exists across the app.
 */
export class AppNavigation implements IAppNavigation {
    ...
    private globalNavigator: any = null;
    ...
    public initialize(props: RouterNavigator): void {
        ...
        this.globalNavigator = props;
    }

    /**
     * Main navigation function
     * @param navTo - Path to navigate to
     * @param navParams - Optional parameters to pass with navigation
     * @param goingBack - Flag indicating backward navigation
     */
     ...
     * @param routePath - Route path from AppRoutes
     * @param navParams - Optional navigation parameters
     */
    ...
    /**
     * Updates the navigation trail in the store
     * @param goingBack - Flag indicating backward navigation
     */
...
/**
 * Singleton instance of AppNavigation
 */
