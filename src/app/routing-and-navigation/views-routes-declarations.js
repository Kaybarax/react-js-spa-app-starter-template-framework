...
export const DEFAULT_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "DEFAULT_VIEW_ROUTE" */ import("../views/page-1-example")),
  path: '/',
};
...
export const PAGE2EXAMPLE_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "PAGE2EXAMPLE_VIEW_ROUTE" */ import("../views/page-2-example")),
  path: '/page-2-example',
};

export const PAGE3EXAMPLE_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "PAGE3EXAMPLE_VIEW_ROUTE" */ import("../views/page-3-example")),
  path: '/page-3-example',
};

export const PAGE4EXAMPLE_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "PAGE4EXAMPLE_VIEW_ROUTE" */ import("../views/page-4-example")),
  path: '/page-4-example',
};
...
export const LOGIN_AND_REGISTRATION_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "LOGIN_AND_REGISTRATION_VIEW_ROUTE" */ import("../views/login-and registration-views/login")),
  path: '/login-and-registration',
};

export const SECURED_HOMEPAGE_EXAMPLE_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "SECURED_HOMEPAGE_EXAMPLE_VIEW_ROUTE" */ import("../views/secured-app-views/secured-homepage-example")),
  path: '/secured-app-home',
};

export const SECURED_PAGE2EXAMPLE_VIEW_ROUTE = {
  component: React.lazy(() =>
      /* webpackChunkName: "SECURED_PAGE2EXAMPLE_VIEW_ROUTE" */ import("../views/secured-app-views/secured-page-2-example")),
