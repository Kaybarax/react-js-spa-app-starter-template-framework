...
@observer
class Page2Example extends React.Component {
    constructor(props) {
        super(props);
    ...
    static routeName = 'Page2Example';
    static routePathPattern = '/Page2Example';

    _continueToPage3 = (e) => {
        e.preventDefault();
        appNavigation.navigateToPage3Example(this.routerStore);
    }
                ...
                <div className={'flex-row-container'}>
                    <div className={'flex-container-child-item center-align-content'}>
                        <p style={{textAlign: 'left'}}>
                            ...
                            <a href={PAGE3EXAMPLE_VIEW_ROUTE.routeName} onClick={e => this._continueToPage3(e)}>
