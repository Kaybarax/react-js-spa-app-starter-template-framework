...
@observer
class Page3Example extends React.Component {
    constructor(props) {
        super(props);
    ...
    static routeName = 'Page3Example';
    static routePathPattern = '/Page3Example';

    _continueToPage4 = (e) => {
        e.preventDefault();
        appNavigation.navigateToPage4Example(this.routerStore);
    }
    render() {
        return (
            <SafeComponentWrapper>
                ...
                <NavigationHeader
                    ...
                    authStore={this.authStore} activity={this}
                />
                ...
                <div className={'flex-row-container'}>
                    <div className={'flex-container-child-item center-align-content'}>
                        <p style={{textAlign: 'left'}}>
                            ...
                            You can read more about <a href={'https://twitter.com/mweststrate'} target={'_blank'}>Michel Weststrate's</a> powerful MobX&nbsp;
                            state manager creation, here, <a href={'https://mobx-state-tree.js.org/intro/philosophy'} target={'_blank'}>About MobX</a><br/>
                            As mentioned earlier, currently, the system design persists your running app's state/stores to, <i>localStorage</i>,&nbsp;
                            Web Storage, but you can upgrade to <i>IndexedDb</i> if you are dealing with heavy data. I have already&nbsp;
                            ...
                            <a href={'https://twitter.com/NareshJBhatia'} target={'_blank'}>Naresh Bhatia</a>. You can see&nbsp;more about it here,&nbsp;
                            <a href={'https://nareshbhatia.github.io/mobx-state-router/docs/guides-getting-started'} target={'_blank'}>About MobX State Router</a>
                            <br/><br/>
                            ...
                            get those components above, and put them together with React js; and you have an all batteries included,&nbsp;
                            shiny whistles and bells, React Js SPA web app template framework to start you off to build, both your web app&nbsp;
                            that facilitates a secure app with sign up, login and authentication; or even a static web app like&nbsp;
                            you would get with Gatsby Js or Next Js, the only difference being that those are Server Side Rendered&nbsp;
                            ...
                            login and sign up, facilities in this web app template framework if you wish, and just use it as an, unsecured&nbsp;
                            ...
                            <a href={PAGE4EXAMPLE_VIEW_ROUTE.routeName} onClick={e => this._continueToPage4(e)}>
