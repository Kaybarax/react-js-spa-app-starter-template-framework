...
@observer
class Page4Example extends React.Component {
  constructor(props) {
    super(props);
  ...
  static routeName = 'Page4Example';
  static routePathPattern = '/Page4Example';
                                  ...
                                  <figure>
                                    ...
                                    <figcaption>
                                      <a href={item.links[0].link}
                                         target={'_blank'}
                                         onClick={e => this._viewAttributedPersonDetails(e, item.person)}
                                      >
                                        {item.person}
                                      </a>
                                    </figcaption>
